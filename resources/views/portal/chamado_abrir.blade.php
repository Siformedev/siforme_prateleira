                ...
                <section class="panel profile-user-content">
                    <div class="panel-body">
                        <div class="nav-tabs-horizontal">
                            {!! Form::open(['route' => ['portal.chamados.store']]) !!}
                                ...
                                <div class="col-md-12">
                                    ...
                                    <span class="step-digit">
                                        ...
                                        <div class="step-desc">
                                            ...
                                            {{--<p>Preencha as informações abaixo em até 1 dia útil sua solicitação será respondida.</p>--}}
                                            <p>Preencha as informações abaixo, em breve sua solicitação será respondida.</p>
                                        </div>
                                    </div>
