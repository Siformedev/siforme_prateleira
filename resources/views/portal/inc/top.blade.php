...
<link rel="stylesheet" type="text/css" href="{{ asset('assets/vendors/cropper/cropper.min.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('assets/vendors/cropper/main.css') }}">
<!-- v1.0.1 -->
