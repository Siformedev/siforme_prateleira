        ...
        <div class="page-content-inner">
            ...
            <section class="panel">
                <div class="panel-heading">
                    <h3>Listagem de Formandos Cancelados</h3>
                    <hr>
                </div>
                        ...
                        <div class="col-md-12">
                            <table class="table table-hover nowrap dataTable dtr-inline table-responsive" id="table1">
                                ...
                                @foreach($formings as $forming)
                                    ...
                                    if($forming->status == 6){
                                        $statusForm = 'Em Processo de Cancelamento';
                                        $labelForm = 'warning';
                                    }elseif($forming->status == 7){
                                        $statusForm = 'Cancelamento Realizado';
                                        $labelForm = 'danger';
                                    }else{
                                        $statusForm = 'Verificar Situação!';
                                        $labelForm = 'default';
                                    }
                                    ?>
                                    <tr>
                                        ...
                                        -->
                                        <td><span class="label label-{{$labelForm}}">{{$statusForm}}</span> </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
