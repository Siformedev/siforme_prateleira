                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <h1><span class="label label-success">{{\App\Course::find($forming->curso_id)['name']}}</span> | <span class="label label-info">{{\App\ConfigApp::Periodos()[$forming->periodo_id]}}</span></h1>
                                                            ...
                                                            <table class="table table-hover dataTable table-responsive" id="table1">
                                                                ...
                                                                @foreach($prods as $product)
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="{{route('comissao.formandos.show.item', ['prod' => $product->id])}}" class="btn btn-success"><i class="icmn icmn-zoom-in"></i></a>
                                                                        </td>
                                                                    </tr>
                                                                @endforeach
                                                                </tbody>
