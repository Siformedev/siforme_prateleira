                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                {{ Form::text('datanascimento', isset($data['datanascimento']), array_merge(['class' => 'form-control', 'id' => 'datanascimento'])) }}
                            </div>
                        </div>
                        ...
                        <div class="col-lg-1">
                            <div class="form-group">
                                ...
                                {{ Form::text('numero', $data['numero'], array_merge(['class' => 'form-control', 'id' => 'numero','required'])) }}
                            </div>
                        </div>
