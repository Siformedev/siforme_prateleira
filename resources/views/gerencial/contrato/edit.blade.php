        ...
        <div class="page-content-inner">
            ...
            <section class="panel">
                <div class="panel-body">
                    ...
                    {!! Form::model($contract, ['route' => ['gerencial.contrato.update', $contract->id]]) !!}
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            {{ Form::select('conclusion_year', \App\ConfigApp::AnosConclusao(), null, array_merge(['class' => 'form-control', 'id' => 'cpf'])) }}
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            {{ Form::select('igpm', [1 => 'SIM', 0 => 'NÃO'], null, array_merge(['class' => 'form-control'])) }}
                        </div>
                    </div>
