<nav class="left-menu">
    ...
    <div class="left-menu-inner scroll-pane jspScrollable" tabindex="0"
        ...
        <ul class="left-menu-list left-menu-list-root list-unstyled">
            ...
            <!--<li class="">
                <a class="left-menu-link" href="<?= url('/gerencial/reportfinance'); ?>">
                    <i class="left-menu-link-icon icmn-list-numbered"></i>
            ...
            {{--                          </ul>--}}
            {{--                      </li>--}}
            {{--            <li class="left-menu-list-su            bmenu">--}}
            {{--                <a class="left-menu-link" href="javascript: voi            d(0);">--}}
