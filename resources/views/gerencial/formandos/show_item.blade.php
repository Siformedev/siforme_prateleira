...
<section class="page-content">
    <div class="page-content-inner">
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12" style="font-size: 16px;">
                        <a class="btn btn-primary float-right" href='javascript:;' id='btnaddparcela'><i class='fa fa-plus'></i> Adicionar um novo registro</a>
                        <div class="col-lg-12">
                            <br/>
                        </div>
    ...
    <div class="modal fade" id="modalparcelas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Parcela</h5>
