...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        "conclusion_month   " => "Mês de de Conclusão",
        "signature_date" => "Data da Assinatura",
        "birthday_date" => "Próximo Aniversário",
        "igpm" => "IGPM",
        "email" => "E-mail",
        ...
        "img" => "Imagem",
        "value" => "Valor",
        "maximum_parcels" => "Máximo de Parcelas",
        "reset_igpm" => "Próximo Reajuste IGPM",
        "date_start" => "Data de Inicio",
        "date_end" => "Data de Fim",
        "course" => "Curso",
        "cellphone" => "Curso",
        "due_date" => "Data de Vencimento",
        "foto_crianca" => "Foto Criança",
        "foto_familia" => "Foto Familia",
        "foto_livre" => "Foto Livre",
    ],
